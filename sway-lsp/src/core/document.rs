...
use sway_core::{parse, semantic_analysis::ast_node::TypedAstNode, CompileAstResult, TypeInfo};
...
impl TextDocument {
    ...
    fn parse_tokens_from_text(&mut self) -> Result<Vec<Diagnostic>, DocumentError> {
